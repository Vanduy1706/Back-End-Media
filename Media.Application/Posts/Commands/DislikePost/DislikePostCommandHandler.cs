...
{
    public class DislikePostCommandHandler : IRequestHandler<DislikePostCommand, ErrorOr<PostResult>>
    {
        private readonly IPostRepository _postRepository;
        private readonly IUserRepository _userRepository;

        public DislikePostCommandHandler(IPostRepository postRepository, IUserRepository userRepository)
        {
            _postRepository = postRepository;
            _userRepository = userRepository;
        }

        public async Task<ErrorOr<PostResult>> Handle(DislikePostCommand command, CancellationToken cancellationToken)
        {
            ...
            if (hasLiker == null)
            {
                return Errors.Liker.DuplicatedLike;
            }

            _postRepository.DislikePost(liker);
